...
def load_model_from_single_file(state_dict, model_names, model_classes, model_resource, torch_dtype, device):
    ...
    for model_name, model_class in zip(model_names, model_classes):
        ...
        #         print(key)
        # if "wan_video_dit" in model_name:
        #     new_state_dict = copy.deepcopy(model_state_dict)  # 复制原始状态字典
        #     for key, value in model_state_dict.items():
        #         print(key)
        #         if '38' in key:
        #             new_key = key.replace("38","40")  # 新的键名
        #             new_state_dict[new_key] = copy.deepcopy(value)  # 复制值到新的键  
        ...
        # if "wan_video_dit" in model_name:
        #     model_state_dict.pop("img_emb.proj.0.bias")
        #     model_state_dict.pop("img_emb.proj.0.weight")
        #     model_state_dict.pop("img_emb.proj.1.bias")
        #     model_state_dict.pop("img_emb.proj.1.weight")
        #     model_state_dict.pop("img_emb.proj.3.bias")
        #     model_state_dict.pop("img_emb.proj.3.weight")
        #     model_state_dict.pop("img_emb.proj.4.bias")
        #     model_state_dict.pop("img_emb.proj.4.weight")
    ...
    def load_lora_v2(self, file_path="", state_dict={}, lora_alpha=1.0, is_final = True):
        ...
        if isinstance(file_path, list):
            ...
            for key in state_dict.keys():
                if "audio_patch_embedding" in key  or "masks_embedding" in key or "first_mask_embedding" in key or "audio_proj" in key:
