...
class WanVideoPipeline_omni(BasePipeline):
    ...
    def fetch_models(self, model_manager: ModelManager):
        ...
        #         state_dict_new[key.split("audio_proj.")[1]] = model_manager.state_dict_new_module[key]
        # self.audio_proj.load_state_dict(state_dict_new,strict=True)

        # state_dict_new = {}
        # for key in model_manager.state_dict_new_module:
        #     if "audio_cond_projs" in key:
        #         state_dict_new[key.split("audio_cond_projs.")[1]] = model_manager.state_dict_new_module[key]
    ...
    def from_model_manager(model_manager: ModelManager, torch_dtype=None, device=None, use_usp=False):
        ...
        pipe = WanVideoPipeline_omni(device=device, torch_dtype=torch_dtype)
