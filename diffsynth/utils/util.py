...
def load_state_dict_from_safetensors(file_path, torch_dtype=None):
    ...
    with safe_open(file_path, framework="pt", device="cpu") as f:
        ...
        # weight_tensor = torch.randn(12, 12)  # 举例：使用随机生成的张量
        # bias_tensor = torch.zeros(12)  # 举例：使用全零张量
        # state_dict["aaa.weight"]=weight_tensor
        # state_dict["aaa.bias"]=bias_tensor
        # state_dict["aaa.weight"].to(torch_dtype)
        # state_dict["aaa.bias"].to(torch_dtype)
    return state_dict
